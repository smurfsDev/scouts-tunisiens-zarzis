					...
					<v-container>
						<v-row>
							<v-col cols="12" sm="12" md="12" lg="12" xl="12">
								<v-text-field prepend-icon="mdi-form-textbox" v-model="form.title" label="العنوان"
									required :error-messages="titleError" outlined counter="25"
									class="mt-3"></v-text-field>
							</v-col>
							<v-col cols="12" sm="12" md="12" lg="12" xl="12">
								<v-text-field prepend-icon="mdi-form-textbox" v-model="form.to" label="الى" required
									:error-messages="toError" outlined counter="25" class="mt-3"></v-text-field>
							</v-col>
							<v-col cols="12" sm="12" md="12" lg="12" xl="12">
								<v-text-field type="date" prepend-icon="mdi-calendar" v-model="form.date"
									:error-messages="dateError" label="تاريخ" required outlined
									class="mt-3"></v-text-field>
							</v-col>
							<v-col cols="12" sm="12" md="12" lg="12" xl="12">
								<v-text-field prepend-icon="mdi-form-textbox" v-model="form.location" label="المكان" required
									:error-messages="locationError" outlined counter="25" class="mt-3"></v-text-field>
							</v-col>
							<v-col cols="12" sm="12" md="12" lg="12" xl="12">
								<v-text-field prepend-icon="mdi-form-textbox" v-model="form.subject" label="الموضوع" required
									:error-messages="subjectError" outlined counter="25" class="mt-3"></v-text-field>
							</v-col>
							<v-col cols="12" sm="12" md="12" lg="12" xl="12">
								<v-textarea prepend-icon="mdi-card-text-outline" v-model="form.body"
									:error-messages="bodyError" label="المحتوى" required outlined counter="255"
	...
	computed: {
		...
		dateError() {
			...
			!this.$v.form.date.required &&
				errors.push("الرجاء ادخال تاريخ ");
		...
		bodyError() {
			...
			!this.$v.form.body.required &&
				errors.push("الرجاء ادخال محتوى الرسالة");
